...
class IndexFileParser:
    ...
    @staticmethod
    def save_index_from_configurations(
        context, path: str, configurations: Union[LazyConfiguration, List[LazyConfiguration]]
    ):
        ...
        formatted_grouped_names = [
            {"path": context.get_project_relpath(file_path), "names": file_names}
